      ...
      <Container>
        <div className="grid py-3.5 gap-x-3 gap-y-4 sm:grid-cols-2 grid-cols-1">
          ...
          <div className="flex items-center justify-center">
            <img
              className={`xl:h-[29rem] sm:m-0  lg:h-[27.5rem] ${
                isService
          ...
          >
            ...
            >
              <div
                className={`${
                  isDownloadApp
                    ? "xl:space-y-6 space-y-4"
                    : "md:space-y-2.5 sm:space-y-1.5  space-y-2.5"
                } w-11/12`}
              >
                {/* title */}
                {isDownloadApp ? (
                  <h1 className="pb-0 xl:text-3xl md:text-2xl text-xl font-bold capitalize xl:tracking-wide">
                    Download Our Grocery <br /> Mobile App And Save <br /> Time,
                    Money
                  </h1>
                ) : (
